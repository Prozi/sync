        ...
        documentation: [
          {
            ...
            meta: {
              ...
              lineno: 21,
              columnno: 2,
              path: "/home/jpietal/projects/game-flow/lib",
              code: {
                id: "astnode100000430",
                name: "exports.Flow",
            ...
            longname: "Flow",
            kind: "class",
            returns: [{ type: { names: ["class"] }, description: "Flow" }],
            memberof: "Flow",
            scope: "instance",
            classdesc: "Creates Flow with Game.",
            params: [
              {
                type: { names: ["Object"] },
                description: "{ debug: boolean, port: number, topic: string }",
                name: "params",
              },
            ],
            properties: [
              { type: { names: ["string"] }, name: "topic" },
              { type: { names: ["Game"] }, name: "game" },
              { type: { names: ["BouncerJs"] }, name: "api" },
              { type: { names: ["Later"] }, name: "cache" },
            ],
            $longname: "Flow",
            $kind: "constructor",
            $docmaLink: "api/#Flow",
          },
          {
            ...
            longname: "Game",
            kind: "class",
            returns: [{ type: { names: ["class"] }, description: "Game" }],
            memberof: "Game",
            scope: "instance",
            classdesc: "The meat",
            params: [
              {
                type: { names: ["Object"] },
                description: "Optional config for game",
                name: "config",
              },
            ],
            properties: [
              {
                type: { names: ["Set"] },
                description: "Set with levels",
                name: "levels",
              },
              {
                type: { names: ["BehaviorSubject"] },
                description: "Observable for events",
                name: "subject$",
              },
            ],
            $longname: "Game",
