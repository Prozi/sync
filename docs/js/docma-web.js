...
var docma = Object.freeze(new DocmaWeb({"version":"3.2.12","routes":[{"id":"api:","type":"api","name":"_def_","path":"api/","contentPath":null,"sourceType":"js"}],"apis":{"_def_":{"documentation":[{"comment":"/**\n   * @param {Object} params { debug: boolean, port: number, topic: string }\n   * @property {string} topic\n   * @property {Game} game\n   * @property {BouncerJs} api\n   * @property {Later} cache\n   * @returns {class} Flow\n   */","meta":{"range":[507,1198],"filename":"flow.js","lineno":22,"columnno":2,"path":"/home/jpietal/projects/sync/lib","code":{"id":"astnode100000434","name":"exports.Flow","type":"MethodDefinition","paramnames":["params"]}},"name":"Flow","longname":"Flow","kind":"class","returns":[{"type":{"names":["class"]},"description":"Flow"}],"memberof":"Flow","scope":"instance","classdesc":"Creates Flow with Game.","params":[{"type":{"names":["Object"]},"description":"{ debug: boolean, port: number, topic: string }","name":"params"}],"properties":[{"type":{"names":["string"]},"name":"topic"},{"type":{"names":["Game"]},"name":"game"},{"type":{"names":["BouncerJs"]},"name":"api"},{"type":{"names":["Later"]},"name":"cache"}],"$longname":"Flow","$kind":"constructor","$docmaLink":"api/#Flow"},{"comment":"/**\n   * @param {Object} config Optional config for game\n   * @property {Set} levels Set with levels\n   * @property {BehaviorSubject} subject$ Observable for events\n   * @returns {class} Game\n   */","meta":{"range":[507,724],"filename":"game.js","lineno":23,"columnno":2,"path":"/home/jpietal/projects/sync/lib","code":{"id":"astnode100000047","name":"exports.Game","type":"MethodDefinition","paramnames":["config"]}},"name":"Game","longname":"Game","kind":"class","returns":[{"type":{"names":["class"]},"description":"Game"}],"memberof":"Game","scope":"instance","classdesc":"The meat","params":[{"type":{"names":["Object"]},"description":"Optional config for game","name":"config"}],"properties":[{"type":{"names":["Set"]},"description":"Set with levels","name":"levels"},{"type":{"names":["BehaviorSubject"]},"description":"Observable for events","name":"subject$"}],"$longname":"Game","$kind":"constructor","$docmaLink":"api/#Game"}],"symbols":["Flow","Game"]}},"app":{"title":"game-flow Documentation","meta":null,"base":"./","entrance":"api","routing":{"method":"path","caseSensitive":true},"server":"github","favicon":""},"template":{"name":"docma-template-zebra","description":"Zebra - Default template for Docma. https://github.com/onury/docma","version":"2.3.1","supportedDocmaVersion":">=2.0.0","author":"Onur Yıldırım","license":"MIT","mainHTML":"index.html","options":{"title":{"label":null},"logo":{"dark":null,"light":null},"sidebar":{"enabled":true,"outline":"flat","collapsed":false,"toolbar":true,"itemsFolded":false,"itemsOverflow":"shrink","badges":true,"search":true,"animations":true},"symbols":{"autoLink":true,"params":"list","enums":"list","props":"list","meta":false},"contentView":{"bookmarks":"h1,h2,h3","faLibs":"all","faVersion":"5.5.0"},"navbar":{"enabled":true,"fixed":true,"dark":false,"animations":true,"menu":[]}}},"partials":{"api":"docma-api","content":"docma-content","notFound":"docma-404"},"elementID":"docma-main","contentElementID":"docma-content","defaultApiName":"_def_","logsEnabled":false}));
